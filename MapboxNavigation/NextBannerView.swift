...
open class NextBannerView: UIView {
    ...
    override open func prepareForInterfaceBuilder() {
        ...
        instructionLabel.instruction = [VisualInstructionComponent(type: .text, text: "Next step", imageURL: nil, maneuverType: .none, maneuverDirection: .none, abbreviation: nil, abbreviationPriority: 0)]
    }
